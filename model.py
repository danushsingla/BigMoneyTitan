...
class Head(nn.Module):
    ...
    def forward(self, x):
        ...
        # compute attention scores "affinities" and divide by dimensions to normalize
...
class Block(nn.Module):
    ...
    def forward(self, x):
        # Layer Norm is applied before, deviation from paper
...
class BigramLanguageModel(nn.Module):
    def __init__(self, batch_size=32, block_size=16, max_iters=15000, eval_interval=500, learning_rate=1e-3, eval_iters=200, 
        ...
        # low learning rate since attention cannot tolerate high learning rates, and if you lower this then increase max_iters to compensate
        ...
        # Divide the embeddings between the heads and go through feed forward
    ...
    def forward(self,idx, targets=None):
        ...
        x = tok_emb + pos_emb # (B,T,C) (Python scales up the pos_emb tensor to match the tok_emb tensor)
        ...
        if targets is None:
            ...
            B, T, C = logits.shape
            # Due to requirementts from cross entropy
